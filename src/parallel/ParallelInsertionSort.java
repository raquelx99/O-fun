...
public class ParallelInsertionSort implements ParallelSortAlgorithm {
    ...
    public void sort(int[] array, int numberOfThreads) {
        ...
        try {
            ...
            System.out.println("Insertion Sort paralelo interrompido.");
        } finally {
            executor.shutdown();
        }
